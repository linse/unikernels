...
let logger = syslog_udp ~config:(syslog_config "ns1.robur.io") net
...
let () =
  register "ns1robur" [dns_handler $ default_random $ default_posix_clock $ default_monotonic_clock $ default_time $ generic_stackv4 default_network ]
